...
function switchTab(tab) {
  ...
  const homeOnly = document.querySelectorAll(".home-only");
  homeOnly.forEach(el => el.classList.toggle("hidden", tab !== "home"));
  ...
  if (hero) hero.style.display = tab === "home" ? "block" : "none";
